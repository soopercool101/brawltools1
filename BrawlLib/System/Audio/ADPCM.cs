...
namespace System.Audio
{
    ...
    internal unsafe struct ADPCMState
    {
        ...
        public short ReadSample()
        {
            ...
            //fixed (short* coefs = _coefs)
                outSample = (0x400 + (scale * outSample << 11) + (_coefs[2 * cIndex] * _yn1) + (_coefs[2 * cIndex + 1] * _yn2)) >> 11;
