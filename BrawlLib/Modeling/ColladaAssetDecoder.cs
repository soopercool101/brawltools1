...
namespace BrawlLib.Modeling
{
    public static unsafe partial class Collada
    {
        ...
        static PrimitiveManager DecodePrimitives(GeometryEntry geo)
        {
            ...
            if (faces > 0)
            {
                manager._faces = new NewPrimitive(faces * 3, OpenGL.GLPrimitiveType.Triangles);
                pTri = (ushort*)manager._faces._indices.Address;
            }
            if (lines > 0)
            {
        ...
        //private static void NullWeight(PrimitiveManager manager, GeometryEntry geo)
        //{
        //    Vector3* pVert = null;
        //    ushort* pVInd = (ushort*)manager._faceData[0].Address;
        //    List<Vertex3> vertList = new List<Vertex3>(manager._pointCount);
        ...
        //}
        //private static void Weight(PrimitiveManager manager, SkinEntry skin, DecoderShell shell, GeometryEntry geo, InfluenceManager iMan)
        //{
        //    MDL0BoneNode[] boneList;
        //    MDL0BoneNode bone = null;
        //    int boneCount;
